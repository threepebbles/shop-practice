...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = -430067418L;
    ...
    public final com.example.practiceShop.domain.member.QMember member;
    ...
    public QRefreshToken(Class<? extends RefreshToken> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.example.practiceShop.domain.member.QMember(forProperty("member")) : null;
    }
